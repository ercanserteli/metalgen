...
if 1:
    ...
    # Dataset.
    desc += '-metal';     dataset = EasyDict(tfrecord_dir='metal', resolution=128);                train.mirror_augment = True
    ...
    # Number of GPUs.
    #desc += '-1gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 64, 16: 64, 32: 32, 64: 16, 128: 8}
