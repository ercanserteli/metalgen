...
def training_loop(
    ...
    total_kimg              = 150, #15000,    # Total length of the training, measured in thousands of real images.
    ...
    resume_kimg             = 4463.0,      # Assumed training progress at the beginning. Affects reporting and training schedule.
