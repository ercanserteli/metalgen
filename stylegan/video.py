...
def main():
    ...
    _G, _D, Gs = pickle.load(open("network-final.pkl", "rb"))
    ...
    w = 128
    h = 128
    src_seeds = [600, 601, 602, 603]
    dst_seeds = [700, 701, 702, 703]
    style_ranges = ([0] * 7 + [range(8, 12)]) * len(dst_seeds)
